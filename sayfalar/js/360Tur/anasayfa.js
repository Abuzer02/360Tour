...
function fotograflariSayfalaIcerik(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            var fotoLi=$('<li class="portfolio-item"><a onclick="fotoTiklanmaSayisi(this.href);" href="fotografincele/'+data[i]._id+'" target="_blank" data='+data[i].tiklanmaSayisi+' tarih='+data[i].eklemeTarihi+'><div class="item-inner"><div class="portfolio-image"><img id="fotolar" src="'+data[i].url+'" alt="" style="width:220px;height:200px;"></div><h5>'+data[i].ad+'</h5></div></a></li>');
